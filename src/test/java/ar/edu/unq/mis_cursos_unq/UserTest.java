...
public class UserTest {
	...
	private User aUser;
	private String firstName = "Byul";
	private String lastName = "Chung Han";
	private String email = "byulchung@biopolitic.com";
	private Integer dNI = 12345678;
	
	@Mock
	private Subject assignedSubjectMock;
	
	@Mock
	private Subject notAssignedSubjectMock;
	
	@Mock
	private Course assignedCourseMock;
	
	@Mock
	private Course notAssignedCourseMock;
	
	@Mock
	private List<Subject> subjectListMock;
